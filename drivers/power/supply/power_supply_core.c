				  ...
				  struct power_supply_battery_info *info, int num)
{
	...
	pr_info("%s, energy_full_design_uwh:%d, charge_full_design_uah:%d,"
		"voltage_min_design_uv:%d, precharge_current_ua:%d, charge_term_current_ua:%d,"
		"constant_charge_current_max_ua:%d, constant_charge_voltage_max_uv:%d,"
		" factory_internal_resistance_uohm:%d, sdp_cur:%d, sdp_limit: %d, "
		"dcp_cur: %d, dcp_limit: %d, cdp_cur: %d,cdp_limit: %d, unknown_cur: %d, "
		"unknown_limit:%d, fchg_cur: %d, fchg_limit: %d, flash_cur: %d, flash_limit: %d\n",
		__func__, info->energy_full_design_uwh, info->charge_full_design_uah,
		info->voltage_min_design_uv, info->precharge_current_ua, info->charge_term_current_ua,
		info->constant_charge_current_max_ua, info->constant_charge_voltage_max_uv,
		info->factory_internal_resistance_uohm, info->cur.sdp_cur, info->cur.sdp_limit,
		info->cur.dcp_cur, info->cur.dcp_limit, info->cur.cdp_cur, info->cur.cdp_limit,
		info->cur.unknown_cur, info->cur.unknown_limit, info->cur.fchg_cur,
		info->cur.fchg_limit, info->cur.flash_cur, info->cur.flash_limit);
